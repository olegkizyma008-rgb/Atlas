    ...
    async execute(context) {
        ...
        try {
            ...
            if (!validation.valid) {
                ...
                // Atlas should ONLY intervene AFTER Grisha verification fails
                // At planning stage, return error for local retry by Tetyana
                this.logger.system('tetyana-plan-tools', `[STAGE-2.1-MCP] ⚠️ Invalid tools detected. Tetyana will retry planning.`);
                ...
                return {
                    ...
                    metadata: {
                        ...
                        stage: 'tool-planning',
                        needsRetry: true,  // Local retry, NOT Atlas replan
                        filteredServers
                    }
                };
            }
