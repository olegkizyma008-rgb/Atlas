...
ATLAS використовує **7 MCP серверів** для повноцінної роботи на macOS:
...
| 3 | **Super Shell** | `super-shell-mcp` | Terminal команди |
| 4 | **AppleScript** | `@mseep/applescript-mcp` | macOS автоматизація |
| 5 | **GitHub** | `@wipiano/github-mcp-lightweight` | GitHub API |
...
## 5. **GitHub Lightweight MCP Server** 📦
...
**ATLAS документація:**
- `docs/MCP_TODO_SYSTEM_SETUP_GUIDE.md` - Setup інструкції (7 серверів)
...
**Версія документа:** 2.1.0 (7 робочих серверів після видалення VSCode)  
**Статус:** Complete Reference ✅ (7/7 серверів задокументовано)
