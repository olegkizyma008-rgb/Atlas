...
- **Файлові операції** (створення, запис, збереження файлів): ЗАВЖДИ додавай filesystem__read_file або filesystem__get_file_info
- **Створення папок**: ЗАВЖДИ додавай filesystem__list_directory для перевірки існування
